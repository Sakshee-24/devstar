<script>
  ...
  let encryptOutput = ''; // Encryption output variable
  let decryptOutput = ''; // Decryption output variable
  ...
  function downloadTXT() {
    const textContent = `Decryption Input: ${document.getElementById("textbox-decrypt").value}\nDecrypted Output: ${decryptOutput}`;
    ...
    <div class="card p-8 relative items-center mx-auto max-w-screen-xl overflow-hidden rounded-lg">
      <div class="gap-4 items-center mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 overflow-hidden">
        ...
        <div>
          ...
          <button
            type="button"
            class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-white focus:outline-none bg-green-500 rounded-lg border border-green-600 hover:bg-green-600 hover:text-white focus:z-10 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-800"
